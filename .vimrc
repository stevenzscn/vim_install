...
"" 引入 C++ 标准库 tags
"set tags+=/usr/include/c++/4.8.3/stdcpp.tags
...
" 设置快捷键实现一键编译及运行
nmap <Leader>m :wa<CR>:cd build/<CR>:!rm -rf vimout<CR>:!cmake CMakeLists.txt<CR>:make<CR><CR>:cw<CR>:cd..<CR>
nmap <Leader>g :wa<CR>:cd build/<CR>:!rm -rf vimout<CR>:!cmake CMakeLists.txt<CR>:make<CR><CR>:cw<CR>:cd..<CR>:!build/vimout<CR>
